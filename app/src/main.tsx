...
console.log(
  ...
  "padding: 4px 3px 3px; background: #1b1b1b; border-radius: 3px 0 0 3px; font-weight: bold; color: #fff;",
  "padding: 4px 3px 3px; background: #fff500; font-weight: bold; color: #1b1b1b;",
  "padding: 4px 3px 3px; background: #1b1b1b; border-radius: 0 3px 3px 0; font-weight: bold; color: #fff;"
);
